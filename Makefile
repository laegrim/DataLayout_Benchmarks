...
CUDA_DIRS := backprop bfs b+tree cfd gaussian heartwall hotspot huffman kmeans lavaMD leukocyte lud myocyte nn	nw srad streamcluster particlefilter pathfinder mummergpu hybridsort dwt2d
